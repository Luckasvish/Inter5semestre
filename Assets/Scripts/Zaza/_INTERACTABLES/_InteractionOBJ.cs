...
public abstract class _InteractionOBJ : MonoBehaviour  // CLASSE MÃE DE INTERAGÍVEIS.
{
    ...
    public abstract _Item itenItHas {get;set;}   //  Item no interagível.
    ...
    public abstract void Interact(_Item itenInHand, Chef chef);  //  Método para lidar com as interações.
